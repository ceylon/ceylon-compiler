...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        final TypeChecker typeChecker = new TypeCheckerBuilder().addSrcDirectory(file).getTypeChecker();
        typeChecker.process();
        final CeylonDocTool ceylonDocTool = new CeylonDocTool(typeChecker.getPhasedUnits().getPhasedUnits(), typeChecker.getContext().getModules());
